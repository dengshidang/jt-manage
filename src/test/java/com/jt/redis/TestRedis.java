...
public class TestRedis {
	...
	public void test02(){
		...
		//定义shardinfo对象
		JedisShardInfo info1 = new JedisShardInfo("192.168.130.128",6379);
		JedisShardInfo info2 = new JedisShardInfo("192.168.130.128",6380);
		JedisShardInfo info3 = new JedisShardInfo("192.168.130.128",6381);
	...
	@Test
	public void test04(){
		System.out.println(new HostAndPort("192.168.130.128",26379));
		
		//连接哨兵的IP+端口
		Set<String> sentinels = new HashSet<String>();
		sentinels.add("192.168.130.128:26379");
		sentinels.add("192.168.130.128:26380");
		sentinels.add("192.168.130.128:26381");
